 ...
 // Função principal ao carregar a janela
 window.onload = function () {
   typeWriter(); // Iniciar a digitação
 };
 ...
 document.addEventListener("DOMContentLoaded", function () {
  ...
  // Função para alternar a exibição do corpo do chatbot
function toggleChatbot() {
    const chatbotBody = document.getElementById("chatbot-body");
    if (chatbotBody.style.display === "none" || chatbotBody.style.display === "") {
      chatbotBody.style.display = "flex"; // Exibir o corpo do chatbot
    } else {
      chatbotBody.style.display = "none"; // Ocultar o corpo do chatbot
    }
  }
